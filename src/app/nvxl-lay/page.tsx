...
const modules = [
  {
    index: '01',
    tag: 'Quy trình // Gán đơn lấy',
    title: 'Gán đơn lấy',
    desc: 'Thao tác quét mã gán đơn cần lấy về bưu cục cho nhân viên giao nhận đi lấy hàng hoặc nhập kho.',
    image: '/nvxl-ganlay.png',
    fallbackText: 'QUY TRÌNH XỬ LÝ HÀNG LẤY // GÁN ĐƠN LẤY',
    meta: 'Thời lượng: 10 phút // Cấp độ: Cơ bản',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e90fa79a2f94c7ed11785d'
  },
  {
    index: '02',
    tag: 'Quy trình // Bắn kiểm',
    title: 'Bắn kiểm',
    desc: 'Thao tác quét bắn kiểm nhận diện trạng thái và số lượng đơn hàng lấy thực tế nhập vào bưu cục.',
    image: '/nvxl-bankiemlay.png',
    fallbackText: 'QUY TRÌNH XỬ LÝ HÀNG LẤY // BẮN KIỂM ĐƠN HÀNG LẤY',
    meta: 'Thời lượng: 10 phút // Cấp độ: Cơ bản',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e90593b8b314db43127e0e'
  },
  {
    index: '03',
    tag: 'Quy trình // Nhận hàng tại Bưu cục',
    title: 'Nhận hàng tại Bưu cục',
    desc: 'Thủ tục tiếp nhận bàn giao hàng từ NVPTTT hoặc khách hàng trực tiếp đến gửi tại bưu cục.',
    image: '/nvxl-nhanhangbc.png',
    fallbackText: 'QUY TRÌNH XỬ LÝ HÀNG LẤY // NHẬN HÀNG TẠI BƯU CỤC',
    meta: 'Thời lượng: 10 phút // Cấp độ: Nghiệp vụ',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9e690ae66b795814a568c'
  },
  {
    index: '04',
    tag: 'Quy trình // Tổng hợp',
    title: 'Tổng hợp quy trình xử lý hàng lấy',
    desc: 'Đánh giá tổng quan và bài học ôn tập về quy trình xử lý hàng lấy và xử lý lỗi chênh lệch số lượng.',
    image: '/nvxl-lay.png',
    fallbackText: 'QUY TRÌNH XỬ LÝ HÀNG LẤY // NHÂN VIÊN XỬ LÝ',
    meta: 'Thời lượng: 2 phút // Cấp độ: Đánh giá',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e90f1bc1dc6bbe38aa1814'
  }
];

export default function NvxlLayPage() {
      ...
      <div className={`hn-page${mounted ? ' hn-mounted' : ''}${!sidebarCollapsed ? ' hn-sidebar-expanded' : ''}`}>
        ...
        <section className="hn-hero-banner">
          ...
          <div className="hn-hero-content">
            ...
            <nav className="hn-hero-breadcrumb">
              ...
              <span className="hn-hero-breadcrumb-sep">›</span>
              <span className="hn-hero-breadcrumb-cur">Quy trình xử lý hàng lấy</span>
            </nav>
            <span className="hn-hero-tag">[ Hệ thống đào tạo vận hành ]</span>
            <h1 className="hn-hero-title">Quy trình xử lý hàng lấy</h1>
            <p className="hn-hero-desc">
              Nghiệp vụ nhận hàng lấy từ NVPTTT bàn giao và nhận hàng của Khách hàng tại Bưu cục
            </p>
          </div>
        </section>
        ...
        <aside className={`hn-sidebar${!sidebarCollapsed ? ' hn-expanded' : ''}`}>
          ...
          <nav className="hn-sidebar-nav">
            {navTabs.map((tab, idx) => {
              const isActive = tab.href === '/nvxl-lay';
              return (
