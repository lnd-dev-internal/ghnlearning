...
const modules = [
  {
    index: '01',
    tag: 'Quy trình // Đóng kiện',
    title: 'Đóng kiện',
    desc: 'Hướng dẫn sắp xếp đơn hàng vào bao tải/kiện lớn, thắt dây đai bảo mật và đóng niêm phong khóa chì trước khi vận chuyển.',
    image: '/nvxl-dongkien.png',
    fallbackText: 'QUY TRÌNH LUÂN CHUYỂN // ĐÓNG KIỆN',
    meta: 'Thời lượng: 10 phút // Cấp độ: Cơ bản',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9e34b7efad2772ebb96af'
  },
  {
    index: '02',
    tag: 'Quy trình // Xuất kiện',
    title: 'Xuất kiện',
    desc: 'Thao tác quét mã kiện xuất kho luân chuyển, gán thông tin tài xế nhận bàn giao và chốt xe tải rời bưu cục.',
    image: '/nvxl-xuatkien.png',
    fallbackText: 'QUY TRÌNH LUÂN CHUYỂN // XUẤT KIỆN',
    meta: 'Thời lượng: 10 phút // Cấp độ: Cơ bản',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9e54fc1dc6bbe38aa1bd8'
  },
  {
    index: '03',
    tag: 'Quy trình // Tổng hợp',
    title: 'Tổng hợp quy trình xử lý luân chuyển',
    desc: 'Bài ôn tập tổng quan toàn bộ nghiệp vụ luân chuyển hàng giữa bưu cục và kho trung chuyển, cách kiểm soát mã vận đơn.',
    image: '/nvxl-lc.png',
    fallbackText: 'QUY TRÌNH LUÂN CHUYỂN // TỔNG HỢP',
    meta: 'Thời lượng: 20 phút // Cấp độ: Đánh giá',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9ec3dae66b795814a569d'
  }
];

export default function NvxlLuanChuyenPage() {
      ...
      <div className={`hn-page${mounted ? ' hn-mounted' : ''}${!sidebarCollapsed ? ' hn-sidebar-expanded' : ''}`}>
        ...
        <section className="hn-hero-banner">
          ...
          <div className="hn-hero-content">
            ...
            <nav className="hn-hero-breadcrumb">
              ...
              <span className="hn-hero-breadcrumb-sep">›</span>
              <span className="hn-hero-breadcrumb-cur">Quy trình xử lý luân chuyển</span>
            </nav>
            <span className="hn-hero-tag">[ Hệ thống đào tạo vận hành ]</span>
            <h1 className="hn-hero-title">Quy trình xử lý luân chuyển</h1>
            <p className="hn-hero-desc">
              Hướng dẫn thao tác đóng kiện,  niêm phong và xuất kiện luân chuyển đi các kho/bưu cục.
            </p>
          </div>
        </section>
        ...
        <aside className={`hn-sidebar${!sidebarCollapsed ? ' hn-expanded' : ''}`}>
          ...
          <nav className="hn-sidebar-nav">
            {navTabs.map((tab, idx) => {
              const isActive = tab.href === '/nvxl-luanchuyen';
              return (
