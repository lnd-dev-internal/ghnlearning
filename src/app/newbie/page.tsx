...
.thumb-fallback{position:absolute;inset:0;background:linear-gradient(135deg,#ffe3c8 0%,#ffb26f 100%);display:flex;align-items:flex-end;justify-content:flex-start;padding:16px}
.thumb-fallback span{display:inline-flex;align-items:center;padding:4px 10px;border-radius:999px;background:rgba(255,255,255,.9);font-family:'Be Vietnam Pro',sans-serif;font-size:12px;font-weight:600;color:#ff5200;letter-spacing:.2px}
.thumb-fallback.newbie-hero{background:linear-gradient(135deg,#ff8c3a 0%,#ffb45f 45%,#ffe0bd 100%);align-items:center;justify-content:space-between;padding:18px 16px}
.thumb-copy{display:flex;flex-direction:column;gap:8px;max-width:150px}
.thumb-kicker{display:inline-flex;align-items:center;align-self:flex-start;padding:4px 8px;border-radius:999px;background:rgba(255,255,255,.22);font-family:'Be Vietnam Pro',sans-serif;font-size:11px;font-weight:700;letter-spacing:.4px;text-transform:uppercase;color:#fff}
.thumb-title{font-family:'Montserrat',sans-serif;font-size:22px;line-height:26px;font-weight:800;color:#fff}
.thumb-note{font-family:'Be Vietnam Pro',sans-serif;font-size:12px;line-height:16px;font-weight:500;color:rgba(255,255,255,.9)}
.thumb-hero-icon{width:76px;height:76px;border-radius:24px;background:rgba(255,255,255,.2);display:flex;align-items:center;justify-content:center;font-size:34px;box-shadow:0 10px 24px rgba(0,0,0,.12)}
...
@media(max-width:960px){
  ...
  .role-avatar{width:48px;height:48px;background:#70BCFF;border-radius:9999px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:22px;}
          ...
          <aside className="sidebar">
            <div className="sidebar-top">
              <div className="sidebar-header">
                ...
                <div className="sidebar-title">GHN<br />Newbie</div>
              </div>
              <nav className="side-nav">
                <a className="side-link active" href="/newbie">
                  <span className="side-icon">🗂️</span>
                  <span className="side-text">Chương trình Hội nhập</span>
                </a>
              </nav>
            </div>
          </aside>
          <section className="content">
            <div className="mobile-role-info">
              <div className="role-container">
                ...
                <div className="role-title">GHN Newbie</div>
              </div>
            </div>
            <div className="breadcrumb">
              <a href="/vanphong">Khối Văn Phòng</a>
              <span className="breadcrumb-sep">›</span>
              <a href="/newbie">GHN Newbie</a>
              <span className="breadcrumb-sep">›</span>
              <span className="breadcrumb-cur">Chương trình Hội nhập</span>
            </div>
            <div className="section-head">
              <h1 className="section-title">Chương trình Hội nhập</h1>
            </div>
            <div className="grid">
              <article className="card">
                <div className="thumb">
                  <div className="thumb-fallback newbie-hero">
                    <div className="thumb-copy">
                      <span className="thumb-kicker">Hội nhập</span>
                      <div className="thumb-title">Vì sao hội nhập quan trọng?</div>
                      <div className="thumb-note">Khởi động hành trình làm việc tại GHN</div>
                    </div>
                    <div className="thumb-hero-icon">💡</div>
                  </div>
                </div>
                <div className="card-body">
                  <div className="card-title">Vì sao Hội nhập quan trọng?</div>
              ...
              <article className="card">
                <div className="thumb">
                  <img src="/newbie-bai1.png" alt="Bài 1: Chào bạn mới" />
                  <div className="thumb-fallback" style={{display:'none'}}><span>Bài 1</span></div>
                </div>
                <div className="card-body">
                  <div className="card-title">Bài 1: Chào bạn mới</div>
                  <div className="card-meta"><span className="clock"></span><span>10 phút</span></div>
                  <a className="btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=69080351612f3364be3ed2a6">Bắt đầu học</a>
                </div>
              </article>
              <article className="card">
                <div className="thumb">
                  <img src="/newbie-bai2.png" alt="Bài 2: An tâm làm việc - Hạnh phúc đồng hành" />
                  <div className="thumb-fallback" style={{display:'none'}}><span>Bài 2</span></div>
                </div>
                <div className="card-body">
                  <div className="card-title">Bài 2: An tâm làm việc - Hạnh phúc đồng hành</div>
                  <div className="card-meta"><span className="clock"></span><span>10 phút</span></div>
                  <a className="btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=6899bb45b13c07557c397aa6">Bắt đầu học</a>
                </div>
              </article>
              <article className="card">
                <div className="thumb">
                  <img src="/newbie-bai3.png" alt="Bài 3: Bật mí bí mật vận hành" />
                  <div className="thumb-fallback" style={{display:'none'}}><span>Bài 3</span></div>
                </div>
                <div className="card-body">
                  <div className="card-title">Bài 3: Bật mí bí mật vận hành</div>
                  <div className="card-meta"><span className="clock"></span><span>10 phút</span></div>
                  <a className="btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=6848fc23e08b39b3a21dfbde">Bắt đầu học</a>
                </div>
              </article>
            </div>
          </section>
