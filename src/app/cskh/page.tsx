        ...
        <div className="main-content">
          <aside className="sidebar">
            <div className="sidebar-header">
              ...
              <div className="sidebar-role">Nhân viên<br />Chăm sóc Khách hàng</div>
            </div>
            <nav className="sidebar-nav">
              <a className="sidebar-link active" href="/cskh">
                <span className="sidebar-link-icon">🗂️</span>
                <span className="sidebar-link-text">Kiến thức tổng quan</span>
              </a>
              <a className="sidebar-link" href="/cskh-khieunai">
                <span className="sidebar-link-icon">🗂️</span>
                <span className="sidebar-link-text">Quy trình xử lý yêu cầu, khiếu nại</span>
              </a>
            </nav>
          </aside>
          ...
          <section className="content">
            <div className="mobile-role-info">
              <div className="role-container">
                ...
                <div className="role-title">NV Chăm sóc Khách hàng</div>
              </div>
            </div>
            <div className="mobile-chip-nav">
              <a href="/cskh" className="chip active">Tổng quan</a>
              <a href="/cskh-khieunai" className="chip">Khiếu nại</a>
            </div>
            <div className="breadcrumb">
              <a href="/vanphong">Khối Văn Phòng</a>
              <span className="breadcrumb-sep">›</span>
              <a href="/cskh">Nhân viên Chăm sóc Khách hàng</a>
              <span className="breadcrumb-sep">›</span>
            ...
            <div className="card-grid">
              <article className="card">
                <img className="card-thumb" src="/cskh-quytrinhxulydon.png" alt="Quy trình xử lý đơn hàng" />
                <div className="card-body">
                  <div className="card-title">Quy trình xử lý đơn hàng</div>
                  <div className="card-meta"><span className="clock"></span><span>15 phút</span></div>
                  <a className="card-btn" href="https://drive.google.com/file/d/1iApul0Bc6JOTPesodqZKmDdntXltX8FN/view">Bắt đầu học</a>
                </div>
              </article>

              <article className="card">
                <img className="card-thumb" src="/cskh-trangthaidon.png" alt="Trạng thái đơn hàng thường gặp" />
                <div className="card-body">
                  <div className="card-title">Trạng thái đơn hàng thường gặp</div>
                  <div className="card-meta"><span className="clock"></span><span>15 phút</span></div>
                  <a className="card-btn" href="https://drive.google.com/file/d/1__DNopTv-Pq4sBuORsAblZu7bPcoH_kp/view">Bắt đầu học</a>
                </div>
              </article>

              <article className="card">
                <img className="card-thumb" src="/cskh-hethong.png" alt="Hệ thống Chăm sóc Khách hàng" />
                <div className="card-body">
                  <div className="card-title">Hệ thống Chăm sóc Khách hàng</div>
                  <div className="card-meta"><span className="clock"></span><span>30 phút</span></div>
                  <a className="card-btn" href="https://drive.google.com/file/d/1LPsR8cJed6KnzPVIvY7j2tBhvmsMcoEu/view">Bắt đầu học</a>
                </div>
              </article>
            </div>
          </section>
