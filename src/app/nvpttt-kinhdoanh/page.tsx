...
const modules = [
  {
    index: '01',
    tag: 'Kinh doanh // Chăm sóc Khách hàng',
    title: 'Chăm sóc Khách hàng',
    desc: 'Bồi dưỡng kỹ năng giao tiếp, lắng nghe và giải quyết khiếu nại của khách hàng tại bưu cục nhằm tối ưu hóa sự hài lòng.',
    image: '/kd-cskh.png',
    fallbackText: 'CHĂM SÓC KHÁCH HÀNG // KINH DOANH',
    meta: 'Thời lượng: 10 phút // Cấp độ: Kỹ năng',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=692ebc93c025d3f2a964a1ed'
  },
  {
    index: '02',
    tag: 'Kinh doanh // Khách hàng lớn',
    title: 'Chăm sóc Khách hàng lớn',
    desc: 'Phương pháp tư vấn sản phẩm, thuyết phục và hỗ trợ giải quyết các khiếu nại phát sinh đối với nhóm Khách hàng VIP/Key Account.',
    image: '/kd-cskhlon.png',
    fallbackText: 'CHĂM SÓC KHÁCH HÀNG LỚN // KINH DOANH',
    meta: 'Thời lượng: 10 phút // Cấp độ: Kỹ năng',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=692eb91c4a325027d16826d1'
  },
  {
    index: '03',
    tag: 'Kinh doanh // Kỹ năng bán hàng',
    title: 'Kỹ năng bán hàng',
    desc: 'Nghiệp vụ giới thiệu các gói dịch vụ GHN, thuyết phục khách hàng mới gửi hàng, chốt deal và giữ chân khách hàng cũ.',
    image: '/kd-banhang.png',
    fallbackText: 'KỸ NĂNG BÁN HÀNG // KINH DOANH',
    meta: 'Thời lượng: 10 phút // Cấp độ: Kỹ năng',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=692eb8644a325027d16826cf'
  }
];

export default function NvptttKinhDoanhPage() {
      ...
      <div className={`hn-page${mounted ? ' hn-mounted' : ''}${!sidebarCollapsed ? ' hn-sidebar-expanded' : ''}`}>
        ...
        <section className="hn-hero-banner">
          ...
          <div className="hn-hero-content">
            ...
            <nav className="hn-hero-breadcrumb">
              ...
              <Link href="/nvpttt">Nhân viên Phát triển Thị trường</Link>
              <span className="hn-hero-breadcrumb-sep">›</span>
              <span className="hn-hero-breadcrumb-cur">Kỹ năng Kinh doanh</span>
            </nav>
            <span className="hn-hero-tag">[ Hệ thống đào tạo vận hành ]</span>
            <h1 className="hn-hero-title">Kỹ năng Kinh doanh</h1>
            <p className="hn-hero-desc">
              Các khóa học bồi dưỡng kỹ năng giao tiếp, tư vấn và chăm sóc khách hàng nhằm thúc đẩy phát triển thị trường hiệu quả.
            </p>
          </div>
        </section>
        ...
        <aside className={`hn-sidebar${!sidebarCollapsed ? ' hn-expanded' : ''}`}>
          ...
          <nav className="hn-sidebar-nav">
            {navTabs.map((tab, idx) => {
              const isActive = tab.href === '/nvpttt-kinhdoanh';
              return (
