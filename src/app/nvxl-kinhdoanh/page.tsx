...
const modules = [
  {
    ...
    desc: 'Bồi dưỡng kỹ năng giao tiếp, lắng nghe và chăm sóc khách hàng tại điểm gửi bưu cục nhằm tối ưu hóa sự hài lòng.',
    image: '/kd-cskh.png',
...
export default function NvxlKinhDoanhPage() {
      ...
      <div className={`hn-page${mounted ? ' hn-mounted' : ''}${!sidebarCollapsed ? ' hn-sidebar-expanded' : ''}`}>
        ...
        <section className="hn-hero-banner">
          ...
          <div className="hn-hero-content">
            ...
            <p className="hn-hero-desc">
              Các khóa học bồi dưỡng kỹ năng chăm sóc khách hàng, tư vấn dịch vụ và tối ưu hóa trải nghiệm khách hàng tại bưu cục.
            </p>
          </div>
        </section>
        ...
        <aside className={`hn-sidebar${!sidebarCollapsed ? ' hn-expanded' : ''}`}>
          ...
          <nav className="hn-sidebar-nav">
            {navTabs.map((tab, idx) => {
              const isActive = tab.href === '/nvxl-kinhdoanh';
              return (
