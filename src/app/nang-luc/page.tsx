...
const COURSES: Course[] = [
  ...
  // ── AI & Công nghệ ──
  { id: 'ai1', track: 'ai', title: 'Thay đổi tư duy, Tự tay kiến tạo công cụ số', short: 'AntiGravity 2.0', level: 'Cơ bản', lessons: '4 bài học', duration: '60 phút', desc: 'Đến với khóa học, bạn sẽ có ngay trợ lý AntiGravity 2.0 tự động làm thay mọi việc mang tính lặp lại trên máy tính và các hệ thống. Hãy để AI làm việc, còn bạn cứ thảnh thơi sáng tạo nhé!', href: 'https://lndghn.space/add-in/491e881b-74bb-4156-a1b3-8ab2a1790306', cover: '/hvnl-antigravity.png' },
