...
export default function NvgnPage() {
      ...
      <div className={`gn-page gn-mounted${!sidebarCollapsed ? ' gn-sidebar-expanded' : ''}`}>
        <div className="gn-container">
          ...
          <nav className="gn-breadcrumb">
            ...
            <span className="gn-breadcrumb-cur">Nhân viên Giao nhận B2B</span>
          </nav>

          {/* Header */}
          <header className="gn-header">
            <span className="gn-header-tag">[ Hệ thống đào tạo vận hành ]</span>
            <h1 className="gn-page-title">Nhân viên Giao nhận B2B</h1>
            <p className="gn-page-desc">
              Chương trình đào tạo chuẩn hóa quy trình nghiệp vụ lấy hàng, giao hàng, lưu trữ chứng từ POD và đối soát công nợ dành riêng cho Nhân viên Giao nhận B2B tại GHN.
            </p>
          ...
          <section className="gn-row">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-giaohang.png" alt="Quy trình giao hàng" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">01</span>
              <span className="gn-row-tag">[ Quy trình // Giao hàng ]</span>
              <h2 className="gn-row-title">Quy trình Giao hàng</h2>
              <p className="gn-row-desc">
                Quy chuẩn giao nhận hàng nặng, các bước giao nhận, xác thực chữ ký khách hàng và hoàn tất trạng thái đơn trên app tài xế.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Cơ bản
              </div>
              <a className="gn-btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=691fd68fbda38916fea7eecf" target="_blank" rel="noopener noreferrer">
          ...
          <section className="gn-row gn-reverse">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-layhang.png" alt="Quy trình lấy hàng" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">02</span>
              <span className="gn-row-tag">[ Quy trình // Lấy hàng ]</span>
              <h2 className="gn-row-title">Quy trình Lấy hàng</h2>
              <p className="gn-row-desc">
                Quy trình kiểm tra thông tin đơn lấy, tiếp nhận và kiểm đếm thực tế gói hàng lớn tại địa chỉ người gửi.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Cơ bản
              </div>
              <a className="gn-btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=693952417c5bb2a0f156c9cf" target="_blank" rel="noopener noreferrer">
                <span>Bắt đầu học</span>
                <span className="gn-btn-arrow">→</span>
              </a>
            </div>
          ...
          {/* Module 3: Quy định POD */}
          <section className="gn-row">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-pod.png" alt="Quy định về POD" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">03</span>
              <span className="gn-row-tag">[ Quy định // POD ]</span>
              <h2 className="gn-row-title">Quy định về POD</h2>
              <p className="gn-row-desc">
                Hướng dẫn chụp ảnh và tải lên chứng từ giao nhận (Proof of Delivery), bảo đảm tính pháp lý và đối soát thông tin giao dịch thành công.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Cơ bản
              </div>
              <a className="gn-btn" href="#">
                <span>Bắt đầu học</span>
                <span className="gn-btn-arrow">→</span>
              </a>
            </div>
          ...
          <section className="gn-row gn-reverse">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-checkin.png" alt="Quy trình Check-in" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">04</span>
              <span className="gn-row-tag">[ Quy trình // Check-in ]</span>
              <h2 className="gn-row-title">Quy trình Check-in</h2>
              <p className="gn-row-desc">
                Quy trình khai báo hoạt động đầu ca, quét mã xác nhận hiện diện tại điểm làm việc và cập nhật tiến độ chuyến xe.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Cơ bản
              </div>
              <a className="gn-btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=691fdcc7bda38916fea7ef15" target="_blank" rel="noopener noreferrer">
                <span>Bắt đầu học</span>
                <span className="gn-btn-arrow">→</span>
              </a>
            </div>
          ...
          {/* Module 5: Lương tạm tính */}
          <section className="gn-row">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-luong.png" alt="Xem lương tạm tính" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">05</span>
              <span className="gn-row-tag">[ Hệ thống // Lương tạm tính ]</span>
              <h2 className="gn-row-title">Xem lương tạm tính</h2>
              <p className="gn-row-desc">
                Hướng dẫn tra cứu thu nhập cá nhân hàng ngày, cách xem bảng tính lương tạm thời trực quan ngay trên ứng dụng GHN.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Hướng dẫn
              </div>
              <a className="gn-btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=691fdd28bda38916fea7ef1a" target="_blank" rel="noopener noreferrer">
                <span>Bắt đầu học</span>
                <span className="gn-btn-arrow">→</span>
              </a>
            </div>
          ...
          {/* Module 6: Giải trình ZNS */}
          <section className="gn-row gn-reverse">
            <div className="gn-img-wrap">
              <img src="/b2b/nvgn-zns.png" alt="Giải trình ZNS" />
            </div>
            <div className="gn-info">
              <span className="gn-row-index">06</span>
              <span className="gn-row-tag">[ Nghiệp vụ // Giải trình ZNS ]</span>
              <h2 className="gn-row-title">Giải trình ZNS</h2>
              <p className="gn-row-desc">
                Các quy định và phương thức phản hồi nhanh khi có yêu cầu giải trình đánh giá dịch vụ từ khách hàng qua tin nhắn Zalo.
              </p>
              <div className="gn-row-meta">
                Thời lượng: 10 phút // Cấp độ: Nghiệp vụ
              </div>
              <a className="gn-btn" href="https://app-driver-web.ghn.vn/survey-detail?surveyId=692670dd7ee3a500ac6bf5e9" target="_blank" rel="noopener noreferrer">
                <span>Bắt đầu học</span>
                <span className="gn-btn-arrow">→</span>
              </a>
            </div>
        ...
        <aside className={`gn-sidebar${!sidebarCollapsed ? ' gn-expanded' : ''}`}>
          ...
          <nav className="gn-sidebar-nav">
            {navTabs.map((tab, idx) => (
              <a key={idx} href={tab.href} className={`gn-sidebar-item${idx === 0 ? ' gn-active' : ''}`}>
        ...
        <div className={`gn-mobile-drawer${mobileDrawerOpen ? ' gn-open' : ''}`}>
          ...
          <nav className="gn-sidebar-nav">
            {navTabs.map((tab, idx) => (
              <a key={idx} href={tab.href} className={`gn-sidebar-item${idx === 0 ? ' gn-active' : ''}`} onClick={() => setMobileDrawerOpen(false)}>
                <span className="gn-sidebar-item-icon">{tab.icon}</span>
