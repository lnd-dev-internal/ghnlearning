...
const modules = [
  {
    index: '01',
    tag: 'Nghiệp vụ // Xử lý Ticket',
    title: 'Xử lý Ticket',
    desc: 'Quy trình tiếp nhận, xử lý khiếu nại, phản hồi ticket yêu cầu từ bộ phận CSKH hoặc khách hàng trên hệ thống.',
    image: '/nvxl-ticket.png',
    fallbackText: 'XỬ LÝ TICKET // NHÂN VIÊN XỬ LÝ',
    meta: 'Thời lượng: 10 phút // Cấp độ: Nghiệp vụ',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9ee2d7efad2772ebb96c2'
  },
  {
    index: '02',
    tag: 'Nghiệp vụ // Quản lý Rủi ro',
    title: 'Tạo phiếu Quản lý Rủi ro',
    desc: 'Hướng dẫn các bước lập phiếu báo cáo sự cố hàng hóa, hư hỏng, mất mát hoặc các tình huống rủi ro khác tại bưu cục.',
    image: '/nvxl-qlrr.png',
    fallbackText: 'TẠO PHIẾU QLRR // NHÂN VIÊN XỬ LÝ',
    meta: 'Thời lượng: 10 phút // Cấp độ: Nghiệp vụ',
    href: 'https://app-driver-web.ghn.vn/survey-detail?surveyId=68e9ef04ae66b795814a56a7'
  }
];

export default function NvxlKhacPage() {
      ...
      <div className={`hn-page${mounted ? ' hn-mounted' : ''}${!sidebarCollapsed ? ' hn-sidebar-expanded' : ''}`}>
        ...
        <section className="hn-hero-banner">
          ...
          <div className="hn-hero-content">
            ...
            <nav className="hn-hero-breadcrumb">
              ...
              <span className="hn-hero-breadcrumb-sep">›</span>
              <span className="hn-hero-breadcrumb-cur">Quy trình khác</span>
            </nav>
            <span className="hn-hero-tag">[ Hệ thống đào tạo vận hành ]</span>
            <h1 className="hn-hero-title">Quy trình khác</h1>
            <p className="hn-hero-desc">
              Các nghiệp vụ hỗ trợ bao gồm xử lý Ticket khiếu nại, phản hồi khách hàng và tạo phiếu quản lý rủi ro trên hệ thống.
            </p>
          </div>
        </section>
        ...
        <aside className={`hn-sidebar${!sidebarCollapsed ? ' hn-expanded' : ''}`}>
          ...
          <nav className="hn-sidebar-nav">
            {navTabs.map((tab, idx) => {
              const isActive = tab.href === '/nvxl-khac';
              return (
